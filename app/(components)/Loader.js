...
export default function TypewriterEffectSmoothDemo() {
    ...
    return (
        <div className="font-primaryFont flex flex-col items-center justify-center h-[100vh]">

            <TypewriterEffectSmooth words={words} />
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
                <svg aria-hidden="true" role="status" className="inline w-14 h-14 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
